...
class Fromula():
    ...
    def Bformula53(audit):
        yearReport1,yearReport2,yearReport3 = Fromula.checkForYear(audit)
        
        yearReport2.B53 = yearReport3.B53 + yearReport2.B23 - yearReport2.A29
        yearReport2.save()
        yearReport1.B53 = yearReport2.B53 + yearReport1.B23 - yearReport1.A29
    ...
    def total2(audit):
            ...
            yearReport1.A43 =  yearReport1.A8 + yearReport1.A9 + yearReport1.A10 + yearReport1.A11 + yearReport1.A12 + yearReport1.A13 + yearReport1.A14 + yearReport1.A15 + yearReport1.A16 + yearReport1.A17 + yearReport1.A18 + yearReport1.A20 + yearReport1.A35
            yearReport1.save()

            
            yearReport2.A43 =  yearReport2.A8 + yearReport2.A9 + yearReport2.A10 + yearReport2.A11 + yearReport2.A12 + yearReport2.A13 + yearReport2.A14 + yearReport2.A15 + yearReport2.A16 + yearReport2.A17 + yearReport2.A18 + yearReport2.A20 + yearReport2.A35
            yearReport2.save()
            
            
            yearReport1.B43 =  yearReport1.B3 + yearReport1.B4 + yearReport1.B5 + yearReport1.B6 + yearReport1.B7 + yearReport1.B8 + yearReport1.B9 + yearReport1.B10 + yearReport1.B11 + yearReport1.B12 
            yearReport1.save()

            
            yearReport2.B43 =  yearReport2.B3 + yearReport2.B4 + yearReport2.B5 + yearReport2.B6 + yearReport2.B7 + yearReport2.B8 + yearReport2.B9 + yearReport2.B10 + yearReport2.B11 + yearReport2.B12 
            yearReport2.save()
    ...
    def total3(audit):
            ...
            yearReport2.B56 = yearReport2.B45 + yearReport2.B1 + yearReport2.B47  + yearReport2.B49 + yearReport2.B50 + yearReport2.B51 + yearReport2.B52 + yearReport2.B52 + yearReport2.B30 + yearReport2.B31 
            yearReport2.save()
